"""
Description: The implementation of Pure_GTEE imputation model (timestamp-dominated imputation model) for the partially-observed time-series.
...
from diy_pypots.models.pure_GTEE.core import _Pure_GTEE
from diy_pypots.models.pure_GTEE.data import DatasetForPure_GTEE
...
class Pure_GTEE(BaseNNImputer):
    ...
    def fit(
        ...
        training_set = DatasetForPure_GTEE(
            train_set, 
            return_X_ori=False, 
            return_y=False, 
            return_TS=True,
