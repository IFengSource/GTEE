...
from diy_pypots.nn.modules.saits.embedding import SaitsEmbedding
from diy_pypots.nn.modules.transformer.attention import ScaledDotProductAttention
from diy_pypots.nn.modules.transformer.layers import TransformerEncoderLayer
...
class BackboneSAITS(nn.Module):
    ...
    def forward(
        self, X, missing_mask, attn_mask: Optional[torch.Tensor] = None
    ) -> Tuple[torch.Tensor, ...]:
