"""
Description: The core wrapper assembles the submodules of ModernTCN-based GTEE imputation model.
...
from diy_pypots.nn.modules.moderntcn.backbone import BackboneModernTCN
from diy_pypots.nn.modules.patchtst.layers import FlattenHead
...
class _ModernTCN_GTEE(nn.Module):
    def __init__(
        self,
        ...
        self.local_backbone = BackboneModernTCN(
            n_steps,
            n_features,
            n_features,
            patch_size,
        ...
        self.local_projection = FlattenHead(
            self.local_backbone.head_nf,
            n_steps,
            n_features,
            head_dropout,
            individual,
    ...
    def forward(
        ...
        in_X = self.local_backbone(in_X)
        local_reconstruction = self.local_projection(in_X)
        local_reconstruction = local_reconstruction.permute(0, 2, 1)
