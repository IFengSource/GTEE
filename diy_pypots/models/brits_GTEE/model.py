"""
Description: The implementation of BRITS-based GTEE imputation model for the partially-observed time-series.
...
from diy_pypots.models.brits_GTEE.core import _BRITS_GTEE
from diy_pypots.models.brits_GTEE.data import DatasetForBRITS_GTEE
...
class BRITS_GTEE(BaseNNImputer):
    def __init__(
        self,
    ...
    def fit(
        ...
        training_set = DatasetForBRITS_GTEE(
            train_set,
            return_X_ori=False,
            return_y=False,
            return_TS=True,
