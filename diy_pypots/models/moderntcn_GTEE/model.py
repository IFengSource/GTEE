"""
Description: The implementation of ModernTCN-based GTEE imputation model for the partially-observed time-series.
...
from diy_pypots.models.moderntcn_GTEE.core import _ModernTCN_GTEE
from diy_pypots.models.moderntcn_GTEE.data import DatasetForModernTCN_GTEE
...
class ModernTCN_GTEE(BaseNNImputer):
    def __init__(
        self,
    ...
    def fit(
        ...
        train_dataset = DatasetForModernTCN_GTEE(
            train_set,
            return_X_ori=False,
            return_y=False,
            return_TS=True,
        ...
        if val_set is not None:
            ...
            val_dataset = DatasetForModernTCN_GTEE(
                val_set,
                return_X_ori=True,
                return_y=False,
                return_TS=True,
